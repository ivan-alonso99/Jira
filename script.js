...
function agregarTarea(event) {
    ...
    <p>${descripcion}</p>
     <h2>${titulo}</h2>
     <button class="trash" onclick="deleteTask(this)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
